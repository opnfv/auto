...
PER=80                      # % of compute resources will be consumed by VM
VM_DISK_MAX=100             # GB - max VM disk size
VM_MEM_MAX=80000            # MB - max VM RAM size
VM_CPUS_MAX=42              # max count of VM CPUs
...
openstack image create --disk-format qcow2 --container-format bare --public \
    --file /opt/images/xenial-server-cloudimg-amd64-disk1.img xenial
