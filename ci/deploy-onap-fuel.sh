...
echo "CMP_COUNT=$CMP_COUNT"
echo "CMP_MIN_MEM=$CMP_MIN_MEM"
echo "CMP_MIN_CPUS=$CMP_MIN_CPUS"

VM_MEM=$(($CMP_MIN_MEM*90/100))
VM_CPUS=$(($CMP_MIN_CPUS*90/100))
VM_COUNT=${CMP_COUNT:-"2"}

echo "Values to be used for VM:"
echo "VM_MEM=$VM_MEM"
...
openstack flavor create --ram $VM_MEM  --vcpus $VM_CPUS --disk 70 m1.xlarge
