...
ONAP_COMPONENT_DISABLE="consul dcaegen2 esr log msb multicloud nbi oof policy uui vfc vnfsdk"
...
cat $CONFIG_FILE
if ( ! ansible-playbook -i $CONFIG_FILE -e "kubelet_max_pods=250" cluster.yml ) ; then
